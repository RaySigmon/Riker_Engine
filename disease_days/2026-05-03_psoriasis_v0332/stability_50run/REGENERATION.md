...
python3 scripts/stability_profiling.py \
  disease_days/2026-05-03_psoriasis_v0332/blind_pc/config.yaml \
  -n 50 \
  --master-seed 42 \
  --keep-runs \
  --output-dir disease_days/2026-05-03_psoriasis_v0332/stability_50run
```
...
- Expected wall clock: ~21.6 hours on Pi 5

## Committed summary files
- `stability_summary.json` — aggregate statistics
