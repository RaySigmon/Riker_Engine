...
python3 scripts/stability_profiling.py \
  disease_days/2026-05-02_crc_v0332/blind_pc/config.yaml \
  -n 50 \
  --master-seed 42 \
  --keep-runs \
  --output-dir disease_days/2026-05-02_crc_v0332/stability_50run
```

## Requirements
- Engine version: v0.3.3.2 (commit 4feee15 or later, no phase code changes)
- Master seed: 42
- Config: `blind_pc/config.yaml` (committed)
- Expected wall clock: ~19.7 hours on Pi 5
