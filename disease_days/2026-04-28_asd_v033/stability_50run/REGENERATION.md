...
python3 scripts/stability_profiling.py \
  disease_days/2026-04-28_asd_v033/blind_pc/config.yaml \
  -n 50 \
  --master-seed 42 \
  --keep-runs \
  --output-dir disease_days/2026-04-28_asd_v033/stability_50run
```

## Requirements
- Engine version: v0.3.3 (commit 1b250ed) or v0.3.3.2 (Phases 3/4 stochastic behavior unchanged)
- Master seed: 42
- Config: `blind_pc/config.yaml` (committed)
- Expected wall clock: ~5 hours on Pi 5
