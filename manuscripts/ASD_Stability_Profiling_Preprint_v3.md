...
Alpha Research Labs | April 2026 | Preprint v3 (revised)
...
Autism spectrum disorder (ASD) is genetically heterogeneous, with over 1,200 candidate genes cataloged in the SFARI database. This heterogeneity has made it difficult to identify convergent transcriptomic signatures that replicate across multiple cohorts. We applied the Riker Engine — a condition-agnostic, six-phase progressive filtering pipeline — to perform a hypothesis-free, genome-wide stability analysis using three ASD postmortem brain discovery cohorts, one brain replication cohort, and three blood replication cohorts (332 ASD samples, 332 control samples, 664 total). The pipeline was executed 50 times with varied stochastic parameters (unique UMAP seeds per run) to distinguish biologically stable gene co-expression modules from clustering artifacts. From approximately 26,800 expressed genes, 376 achieved ≥90% cross-run stability (iron-clad), including 352 genes not in the SFARI database. Among the novel findings, a 26-gene mitochondrial and energy metabolism core cluster reached iron-clad stability, spanning the oxidative phosphorylation system and adjacent metabolism: ATP synthase subunits and assembly factors, Complex III and IV components, TCA cycle enzymes, coenzyme Q biosynthesis enzymes, and mitochondrial solute carriers. When expanded to include glycolysis, V-ATPase, and additional energy metabolism genes at iron-clad stability, the full energy metabolism cluster comprises 41 genes (23 upregulated, 18 downregulated), consistent with a mixed bulk-tissue metabolic signature that may reflect summed cell-specific responses. These findings are consistent with the Cell Danger Response (CDR) hypothesis, which predicts mitochondrial metabolic dysfunction as central to ASD pathophysiology. A targeted query of 27 purinergic signaling genes (P2X, P2Y, and P1 receptors; pannexins; ecto-enzymes) found no receptor at any stability tier, with platform probe limitations for key brain-expressed receptors (P2RY12, P2RX4) constraining detection in two of three discovery cohorts. Additional iron-clad novel candidates include PVALB (parvalbumin interneurons), C1QB and C1QC (complement-mediated synaptic pruning), and GABRA1 (GABAergic inhibitory signaling) — each corresponding to active ASD research directions. All data, code, and stability reports are publicly available.
...
Discovery (brain): 103 ASD samples, 113 control samples across 3 cohorts. GSE28521 includes multiple brain regions per donor (32 frontal cortex, 26 temporal cortex, 21 cerebellum); the engine analyzed all 79 samples across three regions, treating regional heterogeneity as part of the biological signal rather than filtering to cortex only. The ASD transcriptomic signal in the original study was primarily cortical (Voineagu et al., 2011). Replication (brain): 13 ASD, 39 controls. Replication (blood): 216 ASD, 180 controls across 3 cohorts. †GSE26415 controls include 21 ASD-matched subjects and 21 healthy mothers of ASD children (ctrlMO); both groups are labeled "nonaustistic control" in GEO metadata (Kuwano et al., 2011). Note: GSE28521 and GSE28475 share overlapping donors from the Autism Tissue Program and Harvard Brain Bank.
...
The mixed directionality pattern (23 upregulated, 18 downregulated) is consistent with a summed cell-specific purinergic response in bulk brain tissue. Different brain cell types express distinct subsets of purinergic receptors: microglia express P2Y12, P2X4, P2X7, and adenosine A1/A2A/A3 receptors; astroglia express a broader set including P2Y1/2/4/6/12/13/14, P2X1/2/4/7, and A1/A2A/A2B/A3; and oligodendroglia express a partially overlapping repertoire (Naviaux, 2026, Supplementary Tables 1–2). Extracellular ATP (eATP) signaling through these different receptor subsets drives cell-specific metabolic responses — some cells shift toward glycolysis, others toward oxidative phosphorylation — producing the mixed directional pattern observed in bulk tissue. The upregulation of ATP synthase components (ATP5F1A/B, ATPAF1) alongside downregulation of electron transport chain components (UQCRC1, COX7A1, NDUFAF5) and V-ATPase subunits (ATP6V1A/C1/E1) is consistent with active danger signaling and a mixed metabolic state across cell types, as predicted by the CDR framework. CYBA (+0.87, strongest effect) and HSPD1 (+0.64) — encoding ROS-generating NADPH oxidase and the mitochondrial stress chaperone, respectively — are consistent with ongoing CDR activation.

We queried all 27 canonical purinergic signaling genes across the three discovery cohorts (7 P2X receptors, 10 P2Y receptors, 4 adenosine/P1 receptors, 3 pannexins, and 3 ecto-enzymes including ENTPD1/CD39, NT5E/CD73, and ADA). No purinergic receptor reached core gene status in any of the 50 stability runs. This does not exclude receptor involvement in the ASD transcriptomic signal. Two key brain-expressed receptors — P2RY12 (the canonical microglial purinergic receptor) and P2RX4 (expressed on microglia, astroglia, and oligodendroglia) — lack probes on the GPL6883 microarray used by two of three discovery cohorts, creating a platform-level detection gap. Among the ecto-enzymes, ADA (adenosine deaminase) was differentially expressed in all three discovery cohorts with consistent upregulation (log2FC = 0.76) but did not achieve core stability, remaining at the lowest clustering level. The full purinergic receptor query results, including per-gene evidentiary tier classifications and platform probe availability, are reported in Supplementary Table S1.

The 41-gene mitochondrial and energy metabolism cluster represents a potential transcriptomic readout for antipurinergic therapy (APT) studies. If suramin treatment (Naviaux et al., 2017) in mouse models produces corresponding changes in these specific transcripts, that would establish a mechanistic bridge between the metabolomic and transcriptomic levels of the CDR.
...
This analysis uses bulk brain tissue transcriptomics, which cannot resolve cell-type-specific signals. The mitochondrial genes may reflect changes in specific neuronal or glial populations that are diluted by whole-tissue averaging. Single-nucleus RNA-seq pseudo-bulking could reveal whether the mitochondrial cluster is specific to particular cell types. The CDR hypothesis as formulated by Naviaux (2025) emphasizes a critical neurodevelopmental window from late first trimester through approximately 18–36 months of age. Our discovery cohorts range in age from 2 to 60 years, with mean ages substantially outside this window. The mitochondrial signature we detect therefore represents a postmortem transcriptomic state in chronic CDR rather than the developmental window in which CDR stacking is hypothesized to drive ASD emergence. Prospective or earlier-age samples would be needed to test whether this signature is present during the critical window. The discovery datasets are microarray-based postmortem samples; RNA-seq and in vivo data may yield additional candidates. The pipeline identifies consistently differentially expressed genes, not causal drivers. Experimental validation in cell culture or animal models is required to establish functional roles. GSE28521 and GSE28475 share overlapping donors from the same brain banks; while they use different platforms and brain regions, they are not fully independent cohorts. The GSE26415 blood replication cohort uses a combined control group (21 ASD-matched subjects and 21 mothers of ASD children) as deposited in GEO.
...
Dai S, Lin J, Hou X, Luo Y, Shen J, Ou J (2023). Purine signaling pathway dysfunction in autism spectrum disorders: evidence from multiple omics data. Front Mol Neurosci, 16, 1089871.

DerSimonian R, Laird N (1986). Meta-analysis in clinical trials. Controlled Clinical Trials, 7(3), 177–188.

Ginsberg MR, Rubin RA, Falcone T, Ting AH, Natowicz MR (2012). Brain transcriptional and epigenetic associations with autism. PLoS ONE, 7(9), e44736.
...
Naviaux RK (2026). The 3-hit metabolic signaling model for autism spectrum disorder: a summary. Autism Research, 0, e70228.
...
### Supplementary Table S1. Purinergic receptor query results across three ASD brain discovery cohorts.

Each gene is classified into one evidentiary tier: **D1** = detected in all 3 discovery cohorts, never reached core gene status; **D2** = detected in 1–2 of 3 cohorts only, never core; **E** = no probe on GPL6883 microarray (2 of 3 cohorts cannot detect). Probe availability is reported per cohort. GSE28521 and GSE28475 share the GPL6883 (Illumina HumanRef-8 v3.0) platform; GSE64018 is RNA-seq. Naviaux's four priority receptors (Dai et al., 2023) are listed first. *"Present" = gene appears in the expression matrix used for discovery analysis. "Absent" = not present in the expression matrix, whether due to missing probe (microarrays) or non-detection / post-filtering exclusion (RNA-seq).*

**Naviaux priority receptors**

| Gene | Family | Tier | Stability (n/50) | Direction | log2FC | GSE28521 | GSE28475 | GSE64018 | Notes |
|------|--------|------|-------------------|-----------|--------|----------|----------|----------|-------|
| P2RX7 | P2X | D1 | 0/50 | — | — | present | present | present | Detected all 3 cohorts; not DE |
| P2RY2 | P2Y | D2 | 0/50 | — | — | present | present | absent | Detected 2 of 3 cohorts |
| P2RY6 | P2Y | D2 | 0/50 | — | — | present | present | absent | Detected 2 of 3 cohorts |
| P2RY10 | P2Y | D2 | 0/50 | — | — | present | present | absent | Detected 2 of 3 cohorts |

**P2X receptors (ionotropic)**

| Gene | Family | Tier | Stability (n/50) | Direction | log2FC | GSE28521 | GSE28475 | GSE64018 | Notes |
|------|--------|------|-------------------|-----------|--------|----------|----------|----------|-------|
| P2RX1 | P2X | D2 | 0/50 | — | — | present | present | absent | Detected 2 of 3 cohorts |
| P2RX2 | P2X | D2 | 0/50 | — | — | present | present | absent | Detected 2 of 3 cohorts |
| P2RX3 | P2X | D2 | 0/50 | — | — | present | present | absent | Detected 2 of 3 cohorts |
| P2RX4 | P2X | E | 0/50 | — | — | absent | absent | present | No GPL6883 probe |
| P2RX5 | P2X | E | 0/50 | — | — | absent | absent | present | No GPL6883 probe |
| P2RX6 | P2X | D1 | 0/50 | — | — | present | present | present | Detected all 3 cohorts; not DE |

**P2Y receptors (metabotropic)**

| Gene | Family | Tier | Stability (n/50) | Direction | log2FC | GSE28521 | GSE28475 | GSE64018 | Notes |
|------|--------|------|-------------------|-----------|--------|----------|----------|----------|-------|
| P2RY1 | P2Y | D1 | 0/50 | — | — | present | present | present | Detected all 3 cohorts; not DE |
| P2RY4 | P2Y | D2 | 0/50 | — | — | present | present | absent | Detected 2 of 3 cohorts |
| P2RY8 | P2Y | D2 | 0/50 | — | — | present | present | absent | Detected 2 of 3 cohorts |
| P2RY11 | P2Y | D1 | 0/50 | — | — | present | present | present | Detected all 3 cohorts; not DE |
| P2RY12 | P2Y | E | 0/50 | — | — | absent | absent | present | No GPL6883 probe; key microglial receptor |
| P2RY13 | P2Y | D1 | 0/50 | — | — | present | present | present | Detected all 3 cohorts; not DE |
| P2RY14 | P2Y | D1 | 0/50 | — | — | present | present | present | Detected all 3 cohorts; not DE |

**P1/adenosine receptors**

| Gene | Family | Tier | Stability (n/50) | Direction | log2FC | GSE28521 | GSE28475 | GSE64018 | Notes |
|------|--------|------|-------------------|-----------|--------|----------|----------|----------|-------|
| ADORA1 | P1 | D1 | 0/50 | — | — | present | present | present | Detected all 3 cohorts; not DE |
| ADORA2A | P1 | D2 | 0/50 | — | — | present | present | absent | Detected 2 of 3 cohorts |
| ADORA2B | P1 | D1 | 0/50 | — | — | present | present | present | Detected all 3 cohorts; not DE |
| ADORA3 | P1 | D2 | 0/50 | — | — | present | present | absent | Detected 2 of 3 cohorts |

**Pannexin channels (eATP release)**

| Gene | Family | Tier | Stability (n/50) | Direction | log2FC | GSE28521 | GSE28475 | GSE64018 | Notes |
|------|--------|------|-------------------|-----------|--------|----------|----------|----------|-------|
| PANX1 | Pannexin | D1 | 0/50 | — | — | present | present | present | Detected all 3 cohorts; not DE |
| PANX2 | Pannexin | D1 | 0/50 | — | — | present | present | present | Detected all 3 cohorts; not DE |
| PANX3 | Pannexin | D2 | 0/50 | — | — | present | present | absent | Detected 2 of 3 cohorts |

**Ecto-enzymes (eATP metabolism)**

| Gene | Family | Tier | Stability (n/50) | Direction | log2FC | GSE28521 | GSE28475 | GSE64018 | Notes |
|------|--------|------|-------------------|-----------|--------|----------|----------|----------|-------|
| ENTPD1 (CD39) | Ecto-enzyme | D1 | 0/50 | — | — | present | present | present | Detected all 3 cohorts; not DE |
| NT5E (CD73) | Ecto-enzyme | D1 | 0/50 | — | — | present | present | present | Detected all 3 cohorts; not DE |
| ADA | Ecto-enzyme | D1 | 0/50 | up | 0.76 | present | present | present | DE in all 3 cohorts, consistent upregulation; reached Phase 1 but only level 1 clustering — did not achieve core stability |

**Summary:** 0 of 27 purinergic signaling genes reached core gene status in any of 50 stability runs. 12 genes were detected across all 3 cohorts (Tier D1) and showed no differential expression signal; ADA was the lone D1 exception, showing consistent upregulation across all three cohorts but no stability-supported core clustering. 11 genes were detected in 2 of 3 cohorts only (Tier D2), constrained by absence in the GSE64018 RNA-seq dataset. 3 genes (P2RX4, P2RX5, P2RY12) lacked probes on the GPL6883 array used by 2 of 3 cohorts (Tier E). P2RY12 and P2RX4 are expressed on microglia, astroglia, and oligodendroglia (Naviaux, 2026, Supplementary Tables 1–2), making their absence from the GPL6883 platform a meaningful detection gap for the purinergic question specifically. ADA (adenosine deaminase) was the only purinergic-pathway gene to reach Phase 1 differential expression across all three cohorts but did not cluster into any core module.
