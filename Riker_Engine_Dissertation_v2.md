...
The weakest transcriptomic signal. 35 core genes including ATP2B2, SEZ6L2, SNAP25, GABRG2, TBR1. All survived replication. Six stress-response genes correctly eliminated. Blind recovery: 77.1%.

Key finding: ATP2B2 and SEZ6L2 showed significant brain-specific downregulation across four independent postmortem cohorts (random-effects p = 0.037 and 0.046). Blood replication failed, confirming brain specificity.
