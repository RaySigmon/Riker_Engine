...
|---------|--------|-------|----------|-----------|------------|-------------|----------|----------------|
| ASD | Brain cortex | 1,267 | 7 | 11.1% | 35 | 100% | 13 | 77.1% |
| T2D | Pancreatic islets | 443 | 4 | 12.6% | 8 | 100% | 8 | 62.5% |
| IBD | Intestinal mucosa | 762 | 6 | 53.5% | 304 | 99.3% | 296 | 97.7% |
| AD | Brain cortex | 801 | 5 | 54.7% | 394 | 86.3% | 312 | 100% (Ph1) |
| Breast Cancer | Breast tumor | 653 | 5 | 34.8% | 152 | 100% | 121 | N/R |
...
**ASD:** The weakest transcriptomic signal. From 1,267 SFARI candidates, the engine identified 35 core genes including ATP2B2 and SEZ6L2, which showed significant brain-specific downregulation across four independent postmortem cohorts (random-effects p = 0.037 and 0.046 respectively). Blood replication failed, confirming brain specificity. KANK1 was correctly eliminated for significant opposite-direction replication. The hypothesis-free blind run recovered 77.1% of curated core genes despite a 31-fold increase in the FDR denominator.
